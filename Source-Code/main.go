...
func run() {
	...
	// !win.Closed() =  !win.JustPressed(pixelgl.KeyEscape)

	for !win.JustPressed(pixelgl.KeyEscape) { // Keep windows updating for keypresses/events until as long as its NOT closed!
